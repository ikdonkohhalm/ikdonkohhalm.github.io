...
var flag = 1; // I've been trained to feel dirty doing this
...
PS.init = function( system, options ) {
	...
	PS.statusColor(PS.COLOR_RED);
 	PS.statusText( "Snake's Less Goal-Oriented Cousin");
 	PS.gridColor(0x339645);
 	PS.audioLoad("fx_hoot");
 	var randID;
 	function change() {
        randID = PS.random(3);
 		switch (randID) {
			case 1 : PS.statusText("A vast, open world");
			break;
			case 2 : PS.statusText("Interact with your environment");
			break;
			case 3 : PS.statusText("Discover unexpected bugs");
			break;
		}

	}
 	PS.timerStart(200, change);
